...
@section('content')
    <div class="bg-gray-800 rounded-lg shadow-lg p-6 mb-6 border border-gray-700 w-full">
            ...
            <h2 class="text-xl font-semibold text-white">Create New Company</h2>
        </div>

                    <form class="space-y-4" action="{{ route('company.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            <div>
                        ...
                        <div>
                                ...
                                <input type="text" class="w-full px-4 py-2 rounded-lg bg-gray-700 border border-gray-600 text-white focus:outline-none focus:ring-2 focus:ring-blue-500" id="descrption" name="description">
                        </div>
