...
<div class="bg-gray-800 rounded-lg shadow-lg border border-gray-700 w-full">
    ...
    <div class="p-4">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
            ...
            <a href="{{ route('contact.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-500 flex items-center gap-2">
            ...
            <table class="w-full">
                <thead class="bg-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-white font-semibold">Url</th>
                ...
                <tbody class="divide-y divide-gray-700">
                    ...
                    <tr class="text-gray-300">
                        ...
                        <td class="px-4 py-3">{{ Str::limit($item->url,15) }}</td>
                        <td class="px-4 py-3">
                            <div class="flex gap-2">
                                <a href="{{ route('contact.edit', $item->id) }}" class="p-2 text-blue-500 hover:text-blue-400">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="{{ route('contact.destroy', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button class="p-2 text-red-500 hover:text-red-400" onclick="return confirm('are you sure delet this contact?')">
